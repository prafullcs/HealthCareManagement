                ...
                <form noValidate onSubmit={this.onSubmit}>
                  <div className="left-sec-text">
                    ...
                    <div className="input-field col s12">
                      <input
                        onChange={this.onChange}
                        value={this.state.workingHospital}
                        error={errors.workingHospital}
                        id="workingHospital"
                        type="text"
                        className={classnames("", {
                          invalid: errors.workingHospital,
                        })}
                      />
                      <label htmlFor="Working Hospital">Working Hospital</label>
                      <span className="red-text">{errors.workingHospital}</span>
                    </div>
                    <div className="input-field col s12">
                      <input
                        onChange={this.onChange}
                      ...
                      <span className="red-text">{errors.speciality}</span>
                    </div>
                  </div>
                </form>
              </div>
